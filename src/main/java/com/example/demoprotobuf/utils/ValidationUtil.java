...
import com.example.demoprotobuf.exception.BusinessException;
...
public class ValidationUtil {
    ...
    private static void throwParamException(String tip) {
        throw new BusinessException(tip, ResultEnum.REQUEST_PARAMETER_ERROR.getCode());
    }
     ...
     * @param tip
     */
    public static void assertLongRangeValue(Long val, int assertMinVal, int assertMaxVal, String tip) {
        if (val == null || val < assertMinVal || val > assertMaxVal) {
            throwParamException(tip);
        }
    }
     ...
     * @param tip
     */
    public static void assertNotEmptyList(Collection collection, String tip, Object... params) {
